...
NOTEs: 
1. If it won’t run, install .NET 10 Desktop Runtime (Windows x64).
2. Designed for controller play in conjunction with a button mapper such as Xpadder.
3. Windows will most likely block the application. Right-click the zip file, go to properties, and check the "Unblock" box before unzipping.
